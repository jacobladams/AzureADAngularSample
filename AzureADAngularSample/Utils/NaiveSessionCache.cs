...
namespace AzureADAngularSample.Utils
{
	public class NaiveSessionCache : TokenCache
	{
		...
		public void Load()
		{
			...
			this.Deserialize((byte[])MemoryCache.Default.Get(CacheId));
		...
		public void Persist()
		{
			...
			MemoryCache.Default.Add(CacheId, this.Serialize(), DateTimeOffset.MaxValue);
